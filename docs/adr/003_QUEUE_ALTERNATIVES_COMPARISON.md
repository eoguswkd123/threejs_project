...
| 문서                                    | 설명                          |
| --------------------------------------- | ----------------------------- |
| [ADR-001](./001_BACKEND_STACK.md)       | Backend 기술 스택 (상위 결정) |
| [ADR-002](./002_API_LAYER_STACK.md)     | API Layer 프레임워크 선택     |
| [ADR-004](./004_PYTHON_WORKER_STACK.md) | Python Worker 기술 스택       |
...
| 버전  | 날짜       | 변경 내용                                                                                                                                                                                                                                                                                                                                                                                           |
| ----- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0.0.6 | 2025-12-12 | 관련 ADR 참조 섹션 추가 (ADR-001, ADR-002, ADR-004), 섹션 번호 체계 정리 (11.1 관련 ADR, 11.2 관련 문서, 11.3 외부 참조)                                                                                                                                                                                                                                                                            |
